...
namespace Lab3Task3
{
    public class DateService
    {
        ...
        public int span(string date)
        {
            ...
            int span_ = Math.Abs((currentTime.Date - dateTime.Date).Days);

            Console.WriteLine($"Number of days between this date and current time is {span_}");
            return span_;
        }
    }
}
